    ...
    class ProductInfo extends HTMLElement {
      ...
      handleUpdateProductInfo(productUrl) {
        return (html) => {
          ...
          // SAFELY update quantity rules without crashing
          try {
            ...
            console.warn("Safely skipped quantity rule update:", e);
          }

          // RE-ENABLE THE BUTTON (This is what wasn't running!)
      ...
      fetchQuantityRules() {
        ...
        // FIXED: Check if the spinner actually exists before touching it!
        const spinner = this.querySelector(
      ...
      updateQuantityRules(sectionId, html) {
        ...
        // FIXED: Stop crashing if the quantity form was removed from the HTML
